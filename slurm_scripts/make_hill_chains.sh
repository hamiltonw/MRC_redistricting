...
python -u ./make_hill_biased_chain.py --party Democratic --election PRES12 --bias efficiency_gap --n 50000  --state NC --diversity 1 
python -u ./make_hill_biased_chain.py --party Democratic --election PRES12 --bias partisan_bias --n 50000  --state NC --diversity 1
python -u ./make_hill_biased_chain.py --party Democratic --election PRES12 --bias partisan_gini --n 50000  --state NC --diversity 1
python -u ./make_hill_biased_chain.py --party Democratic --election PRES12 --bias safe_seats --n 50000  --state NC --diversity 1

#python -u ./make_hill_biased_chain.py --party Democratic --election PRES16 --bias mean_median --n 50000  --state NC --diversity 1
#python -u ./make_hill_biased_chain.py --party Democratic --election PRES16 --bias efficiency_gap --n 50000  --state NC --diversity 1
#python -u ./make_hill_biased_chain.py --party Democratic --election PRES16 --bias partisan_bias --n 50000  --state NC --diversity 1
#python -u ./make_hill_biased_chain.py --party Democratic --election PRES16 --bias partisan_gini --n 50000  --state NC --diversity 1
#python -u ./make_hill_biased_chain.py --party Democratic --election PRES16 --bias safe_seats --n 50000  --state NC --diversity 1
